...
@pytest.mark.parametrize('card_account_number, expected',[('Visa Platinum 8990922113665229','Visa Platinum 8990 92** **** 5229'),
...
def test_mask_account_card_invalid_value(card_account_number):
